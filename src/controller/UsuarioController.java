...
public class UsuarioController {
    ...
    // Outros m矇todos (atualizar, listar, deletar) seguem o mesmo padr瓊o...
    ...
    public void vincularUsuarioEscola(int escolaId) {
        ...
        // Verificar se j獺 existe v穩nculo
    ...
    public void deletarUsuarioEscola(int escolaId) {
        int id = ConsoleUtil.lerInt("ID do Usuario para remover vi要culo: ", 1, Integer.MAX_VALUE);
        Usuario usuario = usuarioDAO.buscarPorId(id);

        if (usuario != null && usuario.getEscola().getId() == escolaId) {
            usuarioDAO.deletar(id);
            System.out.println("Vi要culo removido com sucesso!");
        } else {
